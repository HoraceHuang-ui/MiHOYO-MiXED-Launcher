      ...
      >
        ...
        >
          <path
            ...
            aria-label="%"
            style="
              -inkscape-font-specification: TT_Skip-E;
              stroke: none;
              stroke-width: 1.84615;
              stroke-miterlimit: 4;
              stroke-dasharray: none;
            "
            transform="matrix(1.3 0 0 1.3 -4.22 -4.231)"
          ></path>
        </g>
      </g>
    </svg>
