    ...
    <div class="transition-all relative"
        ...
        <Transition name="banner">
            <LauncherBanner
                ...
                class="absolute left-16 top-48 z-50 rounded-xl" :banners="launcherInfo.banner"
        ...
        <Transition name="posts">
            <LauncherPosts
                ...
                class="absolute left-16 top-96 z-50 rounded-xl backdrop-blur-md pl-3 pr-1 font-gs"
                style="height: 112px; width: 396px; background-color: rgb(255 255 255 / 0.7)"/>
        </Transition>
        <ScrollWrapper ref="scrollBarRef" height="91vh" width="80vw" class="scroll-wrapper absolute z-40"
                       @scroll="handleScroll"
                       show-bar="never">
