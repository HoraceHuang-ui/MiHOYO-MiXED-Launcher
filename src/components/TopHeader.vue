...
<template>
  <div
    class="drag sticky flex flex-row justify-between z-50 top-0 w-full left-0"
    style="height: 8vh"
  >
    ...
    <div class="no-drag flex flex-row h-full items-center justify-items-center">
      ...
      <img
        ...
        class="mx-2 rounded-lg h-8 transition-all hover:scale-110 active:scale-90"
        @click="genshin"
        :class="{ 'selected hover:scale-100': selection == 1 }"
      />
      <img
        src="../assets/sricon.webp"
        class="mx-2 rounded-lg h-8 transition-all hover:scale-110 active:scale-90"
        @click="starRail"
        :class="{ 'selected hover:scale-100': selection == 2 }"
      />
      <img
        src="../assets/hi3icon.png"
        class="mx-2 rounded-lg h-8 transition-all hover:scale-110 active:scale-90"
        @click="honkai3"
        :class="{ 'selected hover:scale-100': selection == 3 }"
      />
      <img
        ...
        class="mx-2 rounded-lg opacity-60 h-8 transition-all hover:scale-110 active:scale-90"
        style="padding: 2px"
        :class="{ 'selected hover:scale-100': selection == 4 }"
      />
    </div>
